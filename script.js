...
// FULL working file (data + rendering + events)

// ===============================
// DATA: Brand Directory (ALL brands)
// ===============================
const BRANDS = [
  {
    name: "Blueshark",
    ...
    fleetPricingRM: { range: "RM250–400/month", notes: "Subscription bundle dependent." },
  ...
  },
  {
    ...
    batteryModel: { type: "Fixed / charging-led", notes: "Confirm battery removability per SKU." },
    evidence: [],
  ...
  },
  {
    ...
    serviceFootprint: { count: null, notes: "Depends heavily on MY distributor quality." },
    warranty: { battery: "TBD", motor: "TBD", controller: "TBD", notes: "Lock warranty + parts SLA for fleets." },
    fleetPricingRM: { range: "RM160–280/month", notes: "Beware price wars & weak warranty handling." },
  ...
  },
  {
    ...
    strengths: ["Brand recognition", "App/telemetry DNA"],
    ...
    serviceFootprint: { count: null, notes: "Map authorized service centres + parts lead time." },
    warranty: { battery: "TBD", motor: "TBD", controller: "TBD", notes: "" },
    fleetPricingRM: { range: "RM180–300/month", notes: "Works if YOU own uptime + servicing." },
    batteryModel: { type: "Fixed / removable variants (SKU dependent)", notes: "" },
    evidence: [],
    redFlags: ["If data access is blocked, uptime ops will fail."],
    notes: "Good hardware, but you must run fleet discipline.",
  },
  {
    name: "Modenas",
    category: "E-Scooter",
  ...
  },
  {
    ...
    batteryModel: { type: "Fixed (common)", notes: "Confirm removable battery variants by SKU." },
    evidence: [],
    redFlags: ["If distributor is weak, warranty becomes a nightmare."],
    notes: "Potentially good TCO if support is real.",
  },
  {
    name: "QJMOTOR",
    category: "EV Motorcycle / E-Scooter",
    ...
    strengths: ["Distributor strength (often better than unknown sellers)", "Build quality"],
    gaps: ["EV portfolio still maturing"],
    fitBadges: [
    ...
    notes: "Solid option if after-sales for EV is proven.",
  },
  {
  ...
  },
  {
    ...
    evidence: [],
    redFlags: ["Regulatory / road legality limitations."],
    notes: "Security/plantation/industrial niche only.",
  },
  {
    name: "Beam",
    ...
    evidence: [],
    redFlags: ["If you want delivery income vehicles, this is wrong segment."],
  ...
  },
  {
    ...
    evidence: [],
    redFlags: ["Heavy loads will spike failures/warranty."],
  ...
  },
  {
    ...
    serviceFootprint: { count: null, notes: "Verify which seller provides warranty & spares." },
    warranty: { battery: "TBD", motor: "TBD", controller: "TBD", notes: "" },
    fleetPricingRM: { range: "RM70–160/month", notes: "Only if you provide ops/service overlay." },
  ...
  },
  {
    ...
    serviceFootprint: { count: null, notes: "Confirm workshop locations + warranty process." },
    warranty: { battery: "TBD", motor: "TBD", controller: "TBD", notes: "" },
    fleetPricingRM: { range: "Home use", notes: "" },
    batteryModel: { type: "Charging-led", notes: "" },
    evidence: [],
    redFlags: ["Fleet uptime not designed into retail models."],
  ...
  },
  {
    ...
    serviceFootprint: { count: null, notes: "Verify Malaysia warranty/support source." },
    warranty: { battery: "TBD", motor: "TBD", controller: "TBD", notes: "" },
    fleetPricingRM: { range: "Home use", notes: "" },
    batteryModel: { type: "Charging-led", notes: "" },
    evidence: [],
  ...
  // Previously included brands for Home EV motorcycle segment (kept)
  {
    name: "Eclimo",
    category: "EV Motorcycle",
    ...
    batteryModel: { type: "Charging-led", notes: "" },
    evidence: [],
    redFlags: ["If support is thin, fleets churn."],
...
// ===============================
// DATA: Comparison Table (kept readable)
// ===============================
// Note: The table intentionally shows a clean subset; Brand Directory includes all brands.
const DATA = [
  {
    use: "Commercial",
...
function evidenceLinks(evidence) {
  if (!evidence || evidence.length === 0) return `<span class="brandMeta">No evidence links yet</span>`;
  return evidence
    .map(
      (l) =>
...
function brandMatchesGlobalFilters(b) {
  // Type filter: allow "contains" to match multi-category strings
...
function renderBrands() {
  ...
  if (els.brandLabel) els.brandLabel.textContent = state.brand === "all" ? "All" : state.brand;
}
...
function setBrand(brand) {
  state.brand = brand;
  if (els.brandLabel) els.brandLabel.textContent = brand === "all" ? "All" : brand;
  renderBrands();
  renderTable();
}
...
function resetAll() {
  ...
  if (els.brandSort) els.brandSort.value = "score";
...
// ===============================
// EVENTS (safe: only bind if elements exist)
// ===============================
if (els.mode) {
...
if (els.brandGrid) {
  els.brandGrid.addEventListener("click", (e) => {
    ...
    // Click card toggles brand filter
