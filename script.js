// script.js (DIAGNOSTIC + WORKING)
// If anything fails, it will show an error panel on the page.
    ...
    try {
      ...
      const BRANDS = [
        { name: "Blueshark", category: "EV Motorcycle", focus: "Commercial-first (delivery/fleet oriented)", jvScore: 82,
          ...
          fitBadges: [{ t: "Fleet-ready", k: "good" }, { t: "Battery swap", k: "good" }, { t: "Ops discipline needed", k: "warn" }],
        ...
        { name: "Treeletrik", category: "EV Motorcycle", focus: "Mass commuter + light commercial", jvScore: 70,
          ...
          fitBadges: [{ t: "Local presence", k: "good" }, { t: "Value pricing", k: "good" }, { t: "Dealer variance", k: "warn" }],
        ...
        { name: "Modenas", category: "E-Scooter", focus: "Malaysia OEM; delivery-capable scooters", jvScore: 76,
          ...
          fitBadges: [{ t: "Local OEM", k: "good" }, { t: "Delivery-oriented", k: "good" }, { t: "SLA required", k: "warn" }],
        ...
        { name: "Yadea", category: "EV Motorcycle / E-Scooter / E-Bicycle", focus: "Mass-market, price-led", jvScore: 60,
          ...
          fitBadges: [{ t: "Cost scale", k: "good" }, { t: "Ops-dependent", k: "warn" }, { t: "Spec drift risk", k: "warn" }],
        ...
        { name: "NIU", category: "E-Scooter", focus: "Consumer-first; commercial possible with ops overlay", jvScore: 62,
          ...
          fitBadges: [{ t: "Brand recognition", k: "good" }, { t: "Needs ops overlay", k: "warn" }, { t: "Dealer variability", k: "warn" }],
        ...
        { name: "Ebixon (TAILG)", category: "EV Motorcycle / E-Scooter", focus: "China OEM with MY presence", jvScore: 63,
          ...
          fitBadges: [{ t: "Value fleet", k: "good" }, { t: "OEM scale", k: "good" }, { t: "Distributor risk", k: "warn" }],
        ...
        { name: "QJMOTOR", category: "EV Motorcycle / E-Scooter", focus: "MForce-backed brand; EV line growing", jvScore: 68,
          ...
          fitBadges: [{ t: "Distributor strength", k: "good" }, { t: "Mid-tier value", k: "good" }, { t: "EV line evolving", k: "warn" }],
        ...
        { name: "Beam", category: "E-Bicycle (Shared)", focus: "Shared micromobility (campus/township/city)", jvScore: 72,
          ...
          fitBadges: [{ t: "Ops-strong", k: "good" }, { t: "City/campus", k: "good" }, { t: "Not delivery", k: "warn" }],
      ...
      // ============================================================
      const DATA = [
        { use:"Commercial", vehicleType:"EV Motorcycle", bestFor:"Delivery, fleets, couriers (high utilization)", speed:"60–90 km/h", payload:"High", dailyUsage:"80–150 km/day",
        ...
        { use:"Commercial", vehicleType:"E-Scooter", bestFor:"Urban commute fleets, light delivery, intra-city ops", speed:"40–60 km/h", payload:"Medium", dailyUsage:"40–80 km/day",
        ...
        { use:"Commercial", vehicleType:"E-Bicycle", bestFor:"Campus/township fleets, last-mile in dense zones, municipal pilots", speed:"25–35 km/h", payload:"Low–Medium", dailyUsage:"20–50 km/day",
        ...
        { use:"Home", vehicleType:"EV Motorcycle", bestFor:"Commuting with motorcycle preference; occasional longer rides", speed:"60–90 km/h", payload:"High", dailyUsage:"10–60 km/day",
        ...
        { use:"Home", vehicleType:"E-Scooter", bestFor:"Urban commute, short trips, easy ownership", speed:"40–60 km/h", payload:"Medium", dailyUsage:"10–40 km/day",
          batteryStrategy:"Home charging (easy)",
          pricing:"Outright purchase; simpler maintenance",
          brands:["Modenas","NIU","Yadea"]
        },
        { use:"Home", vehicleType:"E-Bicycle", bestFor:"Lifestyle commuting, short-distance errands, fitness-friendly mobility", speed:"25–35 km/h", payload:"Low–Medium", dailyUsage:"5–30 km/day",
